        ...
        with get_session() as session:
            for fecha_str in fechas:
                ...
                if citas_activas:
                    ...
                    print(f"   ⚠️  NO hay citas activas en esa fecha")
                ...
                if not citas_activas and not citas_eliminadas:
                    print(f"   ❌ NO hay citas en esa fecha (ni activas ni eliminadas)")
        ...
        for fecha_str in fechas:
            ...
            if events:
                ...
                for event in events:
                    ...
                    print(f"        Hora: {event['start'].get('dateTime', event['start'].get('date'))}")
            else:
                print(f"   ❌ NO hay eventos en Google Calendar ese día")
