...
async def handle_action_view_availability_day(
    ...
    try:
        ...
        if current_day_date:
            # Recrear y mostrar la última imagen
            ...
            if user_db_id:
                ...
                if imagen_path and os.path.exists(imagen_path):
                    with open(imagen_path, "rb") as img_file:
                        # Si existe message_id anterior, editarlo; si no, crear nuevo
                        if day_photo_id:
                            try:
                                ...
                                # Si no se puede editar, enviar nueva
                    ...
                    reply_markup = InlineKeyboardMarkup(keyboard)
                    await query.edit_message_text(
                        text=f"✅ Última disponibilidad de día guardada",
                        reply_markup=reply_markup
                    )
                    return
        
        # Si no existe imagen anterior, mostrar calendario
